...
#endif
//#undef  _DISABLE_MEX_C_INTERFACE 101

#ifdef _DISABLE_MEX_C_INTERFACE
#include "mex.h"
#endif
...
#ifndef _DISABLE_MEX_C_INTERFACE
int main(void)
{



     MexC_CallAbleRunTime(FFT_LEN,&uIRxSignal[0] , &uCInfoBits[0],(FFT_LEN*MODE_TYPE) );
...
*/
	...
	unsigned char *puCinfoBits;      /* output matrix */
	...
	/* create the output matrix */
	   plhs[0] = mxCreateDoubleMatrix(1,FFT_LEN*MODE_TYPE,mxREAL);
     puCinfoBits = (unsigned char *)mxGetPr(plhs[0]);
    //plhs[0] = mxCreateCharArray(1, (const mwSize *)FFT_LEN*MODE_TYPE);
    //, mxREAL) ;
	...
	*/
//	puCinfoBits = (unsigned char *)mxGetData(plhs[0]); */
 ...
 // if(nrhs != 2) {
   ...
   //MexC_CallAbleRunTime(uISampleLen,uIRxSignal , puCinfoBits,FFT_LEN*MODE_TYPE );
